...
export class AliasPropertyReferenceControllerService {
     ...
     */
    public createPropertyReferenceAliasPatch(id: string, collectionModelObject?: CollectionModelObject, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelAlias>;
    public createPropertyReferenceAliasPatch(id: string, collectionModelObject?: CollectionModelObject, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelAlias>>;
    public createPropertyReferenceAliasPatch(id: string, collectionModelObject?: CollectionModelObject, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelAlias>>;
    public createPropertyReferenceAliasPatch(id: string, collectionModelObject?: CollectionModelObject, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.patch<RepresentationModelAlias>(`${this.configuration.basePath}/v1/resources/aliases/${encodeURIComponent(String(id))}/repo`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createPropertyReferenceAliasPatch1(id: string, collectionModelObject?: CollectionModelObject, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelAlias>;
    public createPropertyReferenceAliasPatch1(id: string, collectionModelObject?: CollectionModelObject, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelAlias>>;
    public createPropertyReferenceAliasPatch1(id: string, collectionModelObject?: CollectionModelObject, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelAlias>>;
    public createPropertyReferenceAliasPatch1(id: string, collectionModelObject?: CollectionModelObject, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.patch<RepresentationModelAlias>(`${this.configuration.basePath}/v1/resources/aliases/${encodeURIComponent(String(id))}/user`,
            collectionModelObject,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createPropertyReferenceAliasPut(id: string, collectionModelObject?: CollectionModelObject, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelAlias>;
    public createPropertyReferenceAliasPut(id: string, collectionModelObject?: CollectionModelObject, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelAlias>>;
    public createPropertyReferenceAliasPut(id: string, collectionModelObject?: CollectionModelObject, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelAlias>>;
    public createPropertyReferenceAliasPut(id: string, collectionModelObject?: CollectionModelObject, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.put<RepresentationModelAlias>(`${this.configuration.basePath}/v1/resources/aliases/${encodeURIComponent(String(id))}/repo`,
            collectionModelObject,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createPropertyReferenceAliasPut1(id: string, collectionModelObject?: CollectionModelObject, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelAlias>;
    public createPropertyReferenceAliasPut1(id: string, collectionModelObject?: CollectionModelObject, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelAlias>>;
    public createPropertyReferenceAliasPut1(id: string, collectionModelObject?: CollectionModelObject, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelAlias>>;
    public createPropertyReferenceAliasPut1(id: string, collectionModelObject?: CollectionModelObject, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.put<RepresentationModelAlias>(`${this.configuration.basePath}/v1/resources/aliases/${encodeURIComponent(String(id))}/user`,
            collectionModelObject,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public followPropertyReferenceAliasGet(id: string, propertyId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelAlias>;
    public followPropertyReferenceAliasGet(id: string, propertyId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelAlias>>;
    public followPropertyReferenceAliasGet(id: string, propertyId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelAlias>>;
    public followPropertyReferenceAliasGet(id: string, propertyId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.get<RepresentationModelAlias>(`${this.configuration.basePath}/v1/resources/aliases/${encodeURIComponent(String(id))}/repo/${encodeURIComponent(String(propertyId))}`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public followPropertyReferenceAliasGet1(id: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<RepresentationModelAlias>;
    public followPropertyReferenceAliasGet1(id: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<HttpResponse<RepresentationModelAlias>>;
    public followPropertyReferenceAliasGet1(id: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<HttpEvent<RepresentationModelAlias>>;
    public followPropertyReferenceAliasGet1(id: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<any> {
        ...
        return this.httpClient.get<RepresentationModelAlias>(`${this.configuration.basePath}/v1/resources/aliases/${encodeURIComponent(String(id))}/repo`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public followPropertyReferenceAliasGet2(id: string, propertyId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelAlias>;
    public followPropertyReferenceAliasGet2(id: string, propertyId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelAlias>>;
    public followPropertyReferenceAliasGet2(id: string, propertyId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelAlias>>;
    public followPropertyReferenceAliasGet2(id: string, propertyId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.get<RepresentationModelAlias>(`${this.configuration.basePath}/v1/resources/aliases/${encodeURIComponent(String(id))}/user/${encodeURIComponent(String(propertyId))}`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public followPropertyReferenceAliasGet21(id: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<RepresentationModelAlias>;
    public followPropertyReferenceAliasGet21(id: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<HttpResponse<RepresentationModelAlias>>;
    public followPropertyReferenceAliasGet21(id: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<HttpEvent<RepresentationModelAlias>>;
    public followPropertyReferenceAliasGet21(id: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<any> {
        ...
        return this.httpClient.get<RepresentationModelAlias>(`${this.configuration.basePath}/v1/resources/aliases/${encodeURIComponent(String(id))}/user`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
