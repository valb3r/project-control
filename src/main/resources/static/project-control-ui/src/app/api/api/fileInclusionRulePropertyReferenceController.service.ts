...
export class FileInclusionRulePropertyReferenceControllerService {
     ...
     */
    public createPropertyReferenceFileinclusionrulePatch(id: string, collectionModelObject?: CollectionModelObject, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelFileInclusionRule>;
    public createPropertyReferenceFileinclusionrulePatch(id: string, collectionModelObject?: CollectionModelObject, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelFileInclusionRule>>;
    public createPropertyReferenceFileinclusionrulePatch(id: string, collectionModelObject?: CollectionModelObject, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelFileInclusionRule>>;
    public createPropertyReferenceFileinclusionrulePatch(id: string, collectionModelObject?: CollectionModelObject, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.patch<RepresentationModelFileInclusionRule>(`${this.configuration.basePath}/v1/resources/fileInclusionRules/${encodeURIComponent(String(id))}/repo`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createPropertyReferenceFileinclusionrulePut(id: string, collectionModelObject?: CollectionModelObject, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelFileInclusionRule>;
    public createPropertyReferenceFileinclusionrulePut(id: string, collectionModelObject?: CollectionModelObject, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelFileInclusionRule>>;
    public createPropertyReferenceFileinclusionrulePut(id: string, collectionModelObject?: CollectionModelObject, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelFileInclusionRule>>;
    public createPropertyReferenceFileinclusionrulePut(id: string, collectionModelObject?: CollectionModelObject, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.put<RepresentationModelFileInclusionRule>(`${this.configuration.basePath}/v1/resources/fileInclusionRules/${encodeURIComponent(String(id))}/repo`,
            collectionModelObject,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public followPropertyReferenceFileinclusionruleGet(id: string, propertyId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<RepresentationModelFileInclusionRule>;
    public followPropertyReferenceFileinclusionruleGet(id: string, propertyId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpResponse<RepresentationModelFileInclusionRule>>;
    public followPropertyReferenceFileinclusionruleGet(id: string, propertyId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<HttpEvent<RepresentationModelFileInclusionRule>>;
    public followPropertyReferenceFileinclusionruleGet(id: string, propertyId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.get<RepresentationModelFileInclusionRule>(`${this.configuration.basePath}/v1/resources/fileInclusionRules/${encodeURIComponent(String(id))}/repo/${encodeURIComponent(String(propertyId))}`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public followPropertyReferenceFileinclusionruleGet1(id: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<RepresentationModelFileInclusionRule>;
    public followPropertyReferenceFileinclusionruleGet1(id: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<HttpResponse<RepresentationModelFileInclusionRule>>;
    public followPropertyReferenceFileinclusionruleGet1(id: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<HttpEvent<RepresentationModelFileInclusionRule>>;
    public followPropertyReferenceFileinclusionruleGet1(id: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/hal+json' | 'text/uri-list'}): Observable<any> {
        ...
        return this.httpClient.get<RepresentationModelFileInclusionRule>(`${this.configuration.basePath}/v1/resources/fileInclusionRules/${encodeURIComponent(String(id))}/repo`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
